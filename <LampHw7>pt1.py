...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 22 00:01:51 2021
...
def get_weather_data(url):
 ...
 # get the precipitation
  ...
  # get next few days' weather
    ...
    return result
#to use the webiste provided in class to find the weather for Athens, Ohio
if __name__ == "__main__":
    #url for the website
    URL = "https://forecast.weather.gov/MapClick.php?lat=39.32920000000007&lon=-82.09978499999994#.YFfVf-YpBN0"
    #to write more freindly user comman line 
    import argparse
    #an easier way to webscript the page
    parser = argparse.ArgumentParser(description="Quick Script for Extracting Weather data using Google Weather")
   #to get the weather from athens ohio
